export default [
  ...
  },
  {
    ...
    name: 'scroll-view',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/scroll-view.html'
  },
  {
    desc: [
    ...
    name: 'swiper',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/swiper.html'
  },
  {
    desc: [
  ...
  },
  {
    ...
    name: 'movable-area',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/movable-view.html',
    since: '1.2.0'
  },
  {
    desc: [
  ...
  },
  {
    ...
    name: 'cover-view',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/cover-view.html',
    since: '1.4.0'
  },
  {
    desc: [
  ...
  },
  {
    ...
    name: 'icon',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/icon.html'
  },
  {
    desc: [
      '文本。'
    ...
    name: 'text',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/text.html'
  },
  {
    desc: [
    ...
    name: 'rich-text',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/rich-text.html',
    since: '1.4.0'
  },
  {
    desc: [
    ...
    name: 'progress',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/progress.html'
  },
  {
    desc: [
      '按钮。'
    ...
    attrs: [
      ...
      },
      {
        enum: [
          ...
          {
            value: 'share',
            desc: '触发用户转发，使用前建议先阅读[使用指引](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/share.html#使用指引)',
            since: '1.2.0'
          },
          {
            value: 'getUserInfo',
          ...
          },
          {
            ...
            desc: '获取用户手机号，可以从bindgetphonenumber回调中获取到用户信息，[具体说明](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/getPhoneNumber.html)',
            since: '1.2.0'
          },
          {
            value: 'launchApp',
            desc: '打开APP，可以通过app-parameter属性设定向APP传的参数[具体说明](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/launchApp.html)',
            since: '1.9.5'
          },
          {
            value: 'openSetting',
          ...
          {
            value: 'feedback',
            desc: '打开“意见反馈”页面，用户可提交反馈内容并上传[日志](https://developers.weixin.qq.com/miniprogram/dev/api/debug/wx.getLogManager.html)，开发者可以登录[小程序管理后台](https://mp.weixin.qq.com/)后进入左侧菜单“客服反馈”页面获取到反馈内容',
            since: '2.1.0'
          }
        ],
        extras: [
    ...
    name: 'button',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/button.html'
  },
  {
    desc: [
    ...
    name: 'checkbox-group',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/checkbox.html'
  },
  {
    desc: [
      '多选项目。'
  ...
  },
  {
    ...
    name: 'form',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/form.html'
  },
  {
    desc: [
    ...
    name: 'input',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/input.html'
  },
  {
    desc: [
    ...
    name: 'label',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/label.html'
  },
  {
    desc: [
    ...
    name: 'picker',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/picker.html'
  },
  {
    desc: [
      '嵌入页面的滚动选择器'
    ...
    name: 'picker-view',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/picker-view.html'
  },
  {
    desc: [
  ...
  },
  {
    ...
    name: 'radio-group',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/radio.html'
  },
  {
    desc: [
      '单选项目'
  ...
  },
  {
    ...
    name: 'slider',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/slider.html'
  },
  {
    desc: [
      '开关选择器。'
    ...
    name: 'switch',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/switch.html'
  },
  {
    desc: [
    ...
    name: 'textarea',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/textarea.html'
  },
  {
    desc: [
      '页面链接。'
    ...
    name: 'navigator',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/navigator.html'
  },
  {
    desc: [
    ...
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/functional-page-navigator.html'
  },
  {
    desc: [
      '音频。'
    ...
    relateApis: [
      {
        ...
        link: 'https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/wx.createAudioContext.html'
      }
    ],
    notices: [
    ...
    name: 'audio',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/audio.html'
  },
  {
    desc: [
      '图片。'
    ...
    attrs: [
      ...
      },
      {
        enum: [
          {
            value: 'scaleToFill',
            desc: '缩放: 不保持纵横比缩放图片，使图片的宽高完全拉伸至填满 image 元素  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/1.png)'
          },
          {
            value: 'aspectFit',
            desc: '缩放: 保持纵横比缩放图片，使图片的长边能完全显示出来。也就是说，可以完整地将图片显示出来。  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/2.png)'
          },
          {
            value: 'aspectFill',
            desc: '缩放: 保持纵横比缩放图片，只保证图片的短边能完全显示出来。也就是说，图片通常只在水平或垂直方向是完整的，另一个方向将会发生截取。  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/3.png)'
          },
          {
            value: 'widthFix',
          ...
          {
            value: 'top',
            desc: '裁剪: 不缩放图片，只显示图片的顶部区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/4.png)'
          },
          {
            value: 'bottom',
            desc: '裁剪: 不缩放图片，只显示图片的底部区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/5.png)'
          },
          {
            value: 'center',
            desc: '裁剪: 不缩放图片，只显示图片的中间区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/6.png)'
          },
          {
            value: 'left',
            desc: '裁剪: 不缩放图片，只显示图片的左边区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/7.png)'
          },
          {
            value: 'right',
            desc: '裁剪: 不缩放图片，只显示图片的右边区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/8.png)'
          },
          {
            value: 'top left',
            desc: '裁剪: 不缩放图片，只显示图片的左上边区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/9.png)'
          },
          {
            value: 'top right',
            desc: '裁剪: 不缩放图片，只显示图片的右上边区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/10.png)'
          },
          {
            value: 'bottom left',
            desc: '裁剪: 不缩放图片，只显示图片的左下边区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/11.png)'
          },
          {
            value: 'bottom right',
            desc: '裁剪: 不缩放图片，只显示图片的右下边区域  原图：![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/0.jpg) 处理后: ![](https://developers.weixin.qq.com/miniprogram/dev/image/cat/12.png)'
          }
        ],
        name: 'mode',
        type: {
    ...
    name: 'image',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/image.html'
  },
  {
    desc: [
    ...
    relateApis: [
      {
        ...
        link: 'https://developers.weixin.qq.com/miniprogram/dev/api/media/video/wx.createVideoContext.html'
      }
    ],
    tips: [
      '请注意[原生组件使用限制](https://developers.weixin.qq.com/miniprogram/dev/component/native-component.html#原生组件的使用限制)。'
    ...
    name: 'video',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/video.html'
  },
  {
    desc: [
    ...
    relateApis: [
      {
        ...
        link: 'https://developers.weixin.qq.com/miniprogram/dev/api/media/camera/wx.createCameraContext.html'
      }
    ],
    tips: [
      '请注意[原生组件使用限制](https://developers.weixin.qq.com/miniprogram/dev/component/native-component.html#原生组件的使用限制)。',
    ...
    name: 'camera',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/camera.html',
    since: '1.6.0',
    authorize: {
      name: 'scope.camera',
  ...
  },
  {
    ...
    name: 'live-player',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/live-player.html',
    since: '1.7.0'
  },
  {
    desc: [
    ...
    name: 'live-pusher',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/live-pusher.html',
    since: '1.7.0',
    authorize: {
  ...
  },
  {
          ...
          definitions: [
            {
              ...
              required: false,
              notice: 'marker点击事件回调会返回此id。**建议为每个marker设置上Number类型id，保证更新marker时有更好的性能。**'
            },
            {
              name: 'latitude',
              type: {
            ...
            },
            {
              ...
              required: true,
              notice: "项目目录下的图片路径，支持相对路径写法，以'/'开头则表示相对小程序根目录；也支持临时路径和网络图片（[2.3.0](https://developers.weixin.qq.com/miniprogram/dev/framework/compatibility.html \"基础库 2.3.0 开始支持，低版本需做兼容处理。\")）"
            },
            {
              name: 'rotate',
              type: {
            ...
            },
            {
              ...
              required: false,
              notice: '{x, y}，x表示横向(0-1)，y表示竖向(0-1)。{x: .5, y: 1} 表示底边中点',
              since: '1.2.0'
            }
          ]
        },
        ...
        type: {
          ...
          definitions: [
            ...
            },
            {
              ...
              required: true,
              notice: "项目目录下的图片路径，支持相对路径写法，以'/'开头则表示相对小程序根目录；也支持临时路径"
            },
            {
              name: 'clickable',
              type: {
    ...
    relateApis: [
      {
        ...
        link: 'https://developers.weixin.qq.com/miniprogram/dev/api/map/wx.createMapContext.html'
      }
    ],
    notices: [
    ...
    name: 'map',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/map.html'
  },
  {
    desc: [
    ...
    relateApis: [
      {
        ...
        link: 'https://developers.weixin.qq.com/miniprogram/dev/api/canvas/wx.createCanvasContext.html'
      }
    ],
    tips: [
      '请注意[原生组件使用限制](https://developers.weixin.qq.com/miniprogram/dev/component/native-component.html#原生组件的使用限制)。'
    ...
    name: 'canvas',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/canvas.html'
  },
  {
    desc: [
      '用于展示微信开放的数据。'
    ...
    name: 'open-data',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/open-data.html',
    since: '1.4.0'
  },
  {
    desc: [
    ...
    name: 'web-view',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/web-view.html',
    since: '1.6.4'
  },
  {
    desc: [
    ...
    name: 'ad',
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/ad.html',
    since: '1.9.94'
  },
  {
    desc: [
    ...
    docLink: 'https://developers.weixin.qq.com/miniprogram/dev/component/official-account.html',
    since: '2.3.0'
  },
  {
    desc: [
