...
/**
 * If the path ends with `.vue.ts`, it's a `.vue` file pre-processed by applets
 ...
 * pre-processed by applets to calculate template diagnostics in TS Language Service
 */
